...
def piecesank(ll, ul):
    ...
    colorsf = []
    #flowcolor = "lavender"
    #rgb_palette = ['rgb(158, 217, 214)', 'rgb(158, 217, 214)', 'rgb(158, 217, 214)', 'rgb(158, 217, 214)', 'rgb(158, 217, 214)', 'rgb(89, 222, 215)', 'rgb(89, 222, 215)', 'rgb(89, 222, 215)', 'rgb(89, 222, 215)', 'rgb(89, 222, 215)']
    ...
    #labelnew=[]
    node=dict(pad=35,thickness=20,label=prodname+procname,color=colorsl)
